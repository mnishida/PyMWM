...
class TestSlitSamples(unittest.TestCase):
    ...
    def setUp(self):
        self.betas = np.array([
            ...
            [0.1,
             0.16144417903988928 + 9.0525203013196318j,
             0.3382796374229029 + 18.186379952074649j,
             0.56259190654597713 + 27.180428791900209j,
             0.91117193019732934 + 35.945442150772699j,
             1.7321012137751648 + 44.290321270767507j]])
        self.convs = np.array([
