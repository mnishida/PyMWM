 ...
 *         jnpu = c_besselJp(n, u)
 */
    __pyx_v_u = __Pyx_c_prod(csqrt(__Pyx_c_diff(__Pyx_c_prod(__Pyx_c_prod(__pyx_v_e1, __pyx_v_w), __pyx_v_w), __Pyx_c_prod(__pyx_v_h, __pyx_v_h))), __pyx_t_double_complex_from_parts(__pyx_v_r, 0));
